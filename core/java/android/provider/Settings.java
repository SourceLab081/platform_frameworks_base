...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * Corner radius for custom QS tile shape.
         * @hide
         */
        @Readable
        public static final String QS_TILE_SHAPE_CORNER_RADIUS = "qs_tile_shape_corner_radius";

        /**
         * Corner radius for custom Brightness slider shape.
         * @hide
         */
        @Readable
        public static final String QS_BRIGHTNESS_SLIDER_SHAPE_CORNER_RADIUS = "qs_brightness_slider_shape_corner_radius";
	...
	/**
        ...
        /**
         * Whether or not double tap to sleep gesture on the home screen is enabled
         * @hide
         */
        public static final String DOUBLE_TAP_SLEEP_GESTURE = "double_tap_homescreen_sleep";
	 ...
	 */
        ...
        static {
            ...
            PUBLIC_SETTINGS.add(WIFI_STANDARD_ICON);
    ...
    public static final class Secure extends NameValueTable {
       ...
       /**
        ...
        /**
         * Whether to show brightness slider in QS
        ...
        /**
         * Position of the brightness slider in QS
         * 0 = Top, 1 = Bottom
         * @hide
         */
        @Readable
        ...
        /**
         * Whether to show the mobile data disable icon in the Status Bar (default on)
         *
         * @hide
         */
        public static final String STATUS_BAR_MOBILE_DATA_DISABLE_ICON = "status_bar_mobile_data_disable_icon";
	...
	/**
        ...
        /**
         * Where to show media player in QS: 0=hide, 1=top, 2=bottom
         * @hide
         */
