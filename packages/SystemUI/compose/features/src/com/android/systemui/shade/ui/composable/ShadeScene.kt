...
import com.android.systemui.qs.ui.composable.QsBrightnessSliderPosition
import com.android.systemui.qs.ui.composable.rememberQsBrightnessSettings
...
private fun ContentScope.SingleShade(
    ...
    val BrightnessSlider =
        @Composable {
            Element(key = QuickSettings.Elements.BrightnessSlider, modifier = Modifier.fillMaxWidth()) {
    ...
    Box(
        ...
        SingleShadeNestedScrollLayout(
            ...
            mediaAndQqsHeader = {
                ...
                MediaAndQqsLayout(
                    brightness =
                        if (qsContainerViewModel.isBrightnessSliderVisible && brightnessSettings.showSlider == 2) {
                            { BrightnessSlider() }
                        } else {
                            {}
                        },
