...
public abstract class WindowManagerInternal {
    ...
    /**
     * Gets the key interception info of the focused window.
     */
    public abstract KeyInterceptionInfo getFocusedWindowKeyInterceptionInfo();

    /**
     * Gets the wallpaper zoom-out level of the focused window.
     */
    public abstract float getFocusedWindowWallpaperZoom();

    /**
     * Gets the timestamp of the last widget interaction.
     */
    public abstract long getLastWidgetInteractionTime();
